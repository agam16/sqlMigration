...
/**
 * @author Agam
 * @description Reads the sql files & Writes them to database maintaining a log
 * @since March 7, 2017
 */
class MigrateDatabase
{
	private $tableName = 'tbl_sql_migration_logs';
	...
	private function __sanitizeSql($contents)
	{
		$comment_patterns = array(
			...
			'/\s*SET SQL_MODE.*\n/', //inline comments start with SET SQL_MODE
			'/\s*SET time_zone.*\n/', //inline comments start with SET time_zone
			'/\s*#.*\n/', //inline comments start with #
		);
